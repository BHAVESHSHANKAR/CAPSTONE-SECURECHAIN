              ...
              <motion.div
                ...
                {isDragActive ? (
                  <motion.p
                    ...
                    {disabled ? (
                      <IconLoader2 className="h-4 w-4 text-neutral-600 dark:text-neutral-400 animate-spin mt-2" />
                    ) : (
                  ...
                  disabled ? (
                    <IconLoader2 className="h-4 w-4 text-neutral-600 dark:text-neutral-300 animate-spin" />
                  ) : (
